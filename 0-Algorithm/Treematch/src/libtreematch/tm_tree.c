...
void super_fast_grouping(tm_affinity_mat_t *aff_mat, tm_tree_t *tab_node, tm_tree_t *new_tab_node, int arity, int solution_size)
{
  ...
  duration = TOC;
  tm_verbose_fprintf(DEBUG,verbose_stdout,"linearization=%fs\n", duration);
  ...
  duration = TOC;
  tm_verbose_fprintf(DEBUG,verbose_stdout,"sorting=%fs\n", duration);
  ...
  duration = TOC;
  tm_verbose_fprintf(DEBUG,verbose_stdout,"Grouping=%fs\n", duration);


  tm_verbose_fprintf(DEBUG,verbose_stdout,"val=%f\n", val);
